...
(defcustom company-dabbrev-code-ignore-prefix nil
          ...
          (t
           ...
           (let ((prefix (if (>= (length prefix) 2)
             ...
             (mapconcat #'regexp-quote
                        ...
                        "\\(\\sw\\|\\s_\\)*")))))
        (ignore-cand-prefix-re (and company-dabbrev-code-ignore-prefix
                                    (not (string-match-p (concat "^" company-dabbrev-code-ignore-prefix) prefix))
                                    (format "\\(?:%s\\)?" company-dabbrev-code-ignore-prefix))))
